...
namespace netGram2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Incentivamos uma conexão com pessoas diversas e assuntos diferentes " +
              "*Juntos contra o burnout*");
            Console.WriteLine("Deseja criar um perfil?");
            Console.WriteLine("Digite: 1 para SIM | 2 para NÃO");
            ...
            Console.WriteLine("Deseja criar uma publicação?");
            Console.WriteLine("Digite: 1 para SIM | 2 para NÃO");
